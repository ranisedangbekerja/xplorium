  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`px-4 py-3 mt-6 text-xs text-white bg-black rounded-md cursor-pointer
      ...
      <div className="flex justify-center gap-2 mt-5 text-xs">
        ...
        <button className="font-medium underline text-blue-600 hover:text-blue-800 cursor-pointer"
